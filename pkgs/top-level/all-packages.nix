...
gcc_unwrapped_4-8 = callPackage ../all-pkgs/g/gcc {
  channel = "4.8";
};
gcc_unwrapped_6 = callPackage ../all-pkgs/g/gcc {
  channel = "6";
};
gcc_unwrapped = callPackageAlias "gcc_unwrapped_6" { };

gcc_48 = wrapCC (callPackageAlias "gcc_unwrapped_4-8" { });
gcc_6 = wrapCC (callPackageAlias "gcc_unwrapped_6" { });
gcc = hiPrio (callPackageAlias "gcc_6" { });
...
gst-plugins-good = callPackageAlias "gst-plugins-good_1-10" { };
...
gstreamer = callPackageAlias "gstreamer_1-10" { };
...
gstreamer-editing-services =
  callPackageAlias "gstreamer-editing-services_1-10" { };
...
gstreamer-vaapi = callPackageAlias "gstreamer-vaapi_1-10" { };
...
#  # Update this when adding the newest kernel major version!
  linuxPackages_latest = pkgs.linuxPackages_4_9;
